...
die_graph_array[0].node_face = face_move_STRIKE;
die_graph_array[1].node_face = face_move_STRIKE;
die_graph_array[2].node_face = face_move_STRIKE;
die_graph_array[3].node_face = face_move_STRIKE;
die_graph_array[4].node_face = face_move_STRIKE;
die_graph_array[5].node_face = face_move_STRIKE;
die_graph_array[6].node_face = face_move_STRIKE;
die_graph_array[7].node_face = face_move_STRIKE;
die_graph_array[8].node_face = face_move_STRIKE;
die_graph_array[9].node_face = face_move_STRIKE;
die_graph_array[10].node_face = face_move_BLOCK;
die_graph_array[11].node_face = face_move_BLOCK;
die_graph_array[12].node_face = face_move_BLOCK;
die_graph_array[13].node_face = face_move_BLOCK;
die_graph_array[14].node_face = face_move_BLOCK;
die_graph_array[15].node_face = face_move_BLOCK;
die_graph_array[16].node_face = face_move_BLOCK;
die_graph_array[17].node_face = face_move_BLOCK;
die_graph_array[18].node_face = face_move_BLOCK;
die_graph_array[19].node_face = face_move_BLOCK;