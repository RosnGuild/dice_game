...
die_graph_array[3].move = face_move_BLOODY_BLOW;
die_graph_array[4].move = face_move_COMBO;
die_graph_array[5].move = face_move_COMBO;
...
die_graph_array[15].move = face_move_SLICE;
die_graph_array[16].move = face_move_SLICE;
die_graph_array[17].move = face_move_SLICE;
