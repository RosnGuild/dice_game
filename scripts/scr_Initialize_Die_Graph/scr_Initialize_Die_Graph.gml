...
die_graph_array[3].move = face_move_STRIKE;
die_graph_array[4].move = face_move_STRIKE;
die_graph_array[5].move = face_move_STRIKE;
die_graph_array[6].move = face_move_STRIKE;
die_graph_array[7].move = face_move_STRIKE;
die_graph_array[8].move = face_move_STRIKE;
die_graph_array[9].move = face_move_STRIKE;
die_graph_array[10].move = face_move_BLOCK;
die_graph_array[11].move = face_move_BLOCK;
die_graph_array[12].move = face_move_BLOCK;
die_graph_array[13].move = face_move_BLOCK;
die_graph_array[14].move = face_move_BLOCK;
die_graph_array[15].move = face_move_BLOCK;
die_graph_array[16].move = face_move_BLOCK;
