...
die_graph_array[0].move = face_move_BLOODY_BLOW;
die_graph_array[1].move = face_move_BLOODY_BLOW;
die_graph_array[2].move = face_move_BLOODY_BLOW;
die_graph_array[3].move = face_move_PORTENT;
die_graph_array[4].move = face_move_PORTENT;
die_graph_array[5].move = face_move_PORTENT;
die_graph_array[6].move = face_move_SHIELD_BASH;
die_graph_array[7].move = face_move_SHIELD_BASH;
die_graph_array[8].move = face_move_STRIKE;
die_graph_array[9].move = face_move_STRIKE;
die_graph_array[10].move = face_move_TRIP;
die_graph_array[11].move = face_move_TRIP;
die_graph_array[12].move = face_move_TRIP;
die_graph_array[13].move = face_move_SLICE;
die_graph_array[14].move = face_move_SLICE;
die_graph_array[15].move = face_move_PORTENT;
die_graph_array[16].move = face_move_PORTENT;
die_graph_array[17].move = face_move_PORTENT;
die_graph_array[18].move = face_move_SLICE;
die_graph_array[19].move = face_move_SLICE;